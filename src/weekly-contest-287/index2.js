...
var findWinners = function (matches) {
    ...
    let ret1 = winners.filter(w => !(w in playerToLostCount)).map(str => Number.parseInt(str));
    let ret2 = losers.filter(l => playerToLostCount[l] === 1).map(str => Number.parseInt(str));
