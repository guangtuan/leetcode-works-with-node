const a = ["ATM",
    ...
    "withdraw",
    "deposit",
    "deposit", "deposit", "deposit", "withdraw", "withdraw", "withdraw", "withdraw", "deposit", "withdraw", "deposit", "withdraw", "deposit", "withdraw", "withdraw", "withdraw", "withdraw", "withdraw", "withdraw", "deposit", "withdraw", "withdraw", "deposit", "withdraw", "withdraw", "deposit", "withdraw", "withdraw", "deposit", "withdraw", "deposit", "deposit", "withdraw", "deposit", "withdraw", "withdraw", "withdraw", "withdraw", "deposit", "deposit", "withdraw", "deposit", "deposit", "deposit", "deposit", "withdraw", "withdraw", "withdraw", "withdraw", "withdraw", "withdraw", "withdraw", "deposit", "withdraw", "deposit", "deposit", "deposit", "withdraw", "deposit", "deposit", "deposit", "deposit", "withdraw", "withdraw", "withdraw", "deposit", "withdraw", "deposit", "withdraw", "deposit", "withdraw", "deposit", "deposit", "withdraw", "deposit", "deposit", "deposit", "deposit", "deposit", "deposit", "withdraw", "withdraw", "deposit", "withdraw", "withdraw", "deposit", "deposit", "deposit", "deposit", "deposit", "deposit", "withdraw", "withdraw", "deposit", "withdraw", "withdraw", "deposit", "deposit", "deposit", "withdraw", "deposit", "withdraw", "deposit", "deposit", "withdraw", "withdraw", "withdraw", "deposit", "withdraw", "deposit", "deposit", "deposit"];
const b = [
    [],
...
for (let ele of zip.slice(0, 20)) {
    const { action, data } = ele;
    if (action === "deposit") {
        atm.deposit(data);
        console.log(null);
    } else {
        console.log(atm.withdraw(data));
    }
}