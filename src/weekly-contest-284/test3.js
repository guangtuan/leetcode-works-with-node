...
const testCases = [
    ...
    {
        input: {
            nums: [2, 5, 6, 2, 10, 18, 14, 7, 3, 0, 18, 15, 10, 9, 11, 19, 3, 19, 4, 8, 10, 14, 11, 5, 2, 17, 0, 2, 0, 11, 12, 11, 2, 9, 2, 6, 0, 14, 7, 19, 17, 13, 4, 4, 11, 19, 9, 1, 10],
            k: 6
        },
        output: 14
    },
    ...
    {
        input: {
            nums: [94, 23, 58, 92, 3, 63, 68, 43, 8, 97, 54, 11, 63, 55, 73, 38, 22, 80, 45, 43, 25, 34, 67, 76, 80, 9, 30, 27, 50, 7, 57, 63, 63, 27, 46, 1, 50, 55, 99, 92, 73, 9, 57, 25, 59, 54, 100, 56, 64, 94, 99],
            k: 79
        },
        output: 100
    },
